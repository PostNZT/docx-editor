...
The editor is consumed as an npm package (`@PostNZT/docx-editor`) via the `<DocxEditor>` component. Consumers need to localize the UI for their end users without forking.
