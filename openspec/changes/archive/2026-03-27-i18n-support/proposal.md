...
- Ship locale JSON files under `i18n/en.json` (required, bundled) with community-contributed locales as optional imports (e.g., `@PostNZT/docx-editor/i18n/pl.json`)
