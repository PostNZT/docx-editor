...
Separate package (`@PostNZT/docx-editor-agents`) under BSL-1.1 — source-available, free for non-production, paid subscription for commercial use.

## What Changes

- **New package** `packages/agent-use/` → `@PostNZT/docx-editor-agents` (BSL-1.1)
...
- **Peer dependency**: `@PostNZT/docx-core` — no code duplication
