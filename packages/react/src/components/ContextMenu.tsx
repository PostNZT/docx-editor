...
import type { AIAction, SelectionContext } from '@postnzt/docx-core/types/agentApi';
import { getActionDescription, DEFAULT_AI_ACTIONS } from '@postnzt/docx-core/types/agentApi';
