...
// Ported from upstream eigenpal/docx-editor #627: non-Word tools occasionally
// emit DOCX parts with stray unescaped ampersands; the strict sax parser would
// otherwise reject the whole document.
